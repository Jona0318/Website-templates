# Cascara — premium koffie Shopify theme

A Shopify **Online Store 2.0** theme, ready to import as a `.zip`. Modern, premium
look with a gold accent (`#C89B3C`). Built to sell products: hero, featured
collection, product/collection/cart pages, blog, search and more.

## Import into Shopify

1. Download `downloads/cascara-shopify-theme.zip` from this repo.
