# Lumière — premium beauty Shopify theme

A Shopify **Online Store 2.0** theme, ready to import as a `.zip`. Modern, premium
look with a gold accent (`#C0922F`). Built to sell products: hero, featured
collection, product/collection/cart pages, blog, search and more.

## Import into Shopify

1. Download `downloads/lumiere-shopify-theme.zip` from this repo.
...
- Accent color default: `#C0922F`
- Background default: `#FCF5F3`
