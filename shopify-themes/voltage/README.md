# Voltage — premium elektronica Shopify theme

A Shopify **Online Store 2.0** theme, ready to import as a `.zip`. Modern, premium
look with a gold accent (`#D4A23A`). Built to sell products: hero, featured
collection, product/collection/cart pages, blog, search and more.

## Import into Shopify

1. Download `downloads/voltage-shopify-theme.zip` from this repo.
...
- Accent color default: `#D4A23A`
- Background default: `#0C0E13`
